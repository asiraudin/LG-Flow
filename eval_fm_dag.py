...
from synthetic import TPUSamplingMetrics, PriceSamplingMetrics
...
@hydra.main(version_base=None, config_path="./configs", config_name="tputile_fm_test")
def main(cfg):
